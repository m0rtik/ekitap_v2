  ...
  return (
    <>
      <div className="size-full bg-white">
        ...
        <div className="w-full h-[calc(100vh_-_4rem)] flex">
          <div className="w-16 h-full bg-white border-r border-zinc-200 sticky top-0 shrink-0 z-10">
            <div className="flex flex-col h-full">
              <div className="flex flex-col space-y-4 py-3.5">
                <span className="group relative">
                  <button type="button" onClick={toggleSidebar} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className="cursor-pointer size-9 rounded-md flex items-center justify-center justify-self-center transition hover:bg-zinc-100">
                    {!isOpen ? <i className="text-lg ri-gallery-view-2"></i> : <i className="text-lg ri-layout-grid-fill"></i>}
                  </button>
          ...
          <div
            className={`bg-zinc-50 transition-[width] ${isPinned ? `sticky top-0 h-full ${isOpen ? "w-80 border-r border-zinc-200" : "w-0"}` : `fixed left-16 top-16 h-[calc(100%_-_4rem)] ${isOpen ? "w-80 border-r border-zinc-200" : "w-0"}`} shrink-0 overflow-hidden z-20`}
            onMouseEnter={() => {
              if (!isPinned) {
          ...
          <div className="transition-[width] size-full relative">
            <div className={`h-16 flex items-center shrink-0 bg-zinc-50 border-b border-zinc-200 absolute top-0 left-0 right-2 transition`}>
              <div className="container">
                <div className="flex items-center">
                  ...
                  <span className="group relative ml-auto">
                    <Link href="#next" className="flex items-center space-x-4 transition hover:text-blue-500 group">
                      <span className="text-sm font-medium">Следующйи урок</span>
